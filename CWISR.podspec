#
#  Be sure to run `pod spec lint CWISR.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "caowen" => "1149863953@qq.com" }
  # Or just: s.author    = "caowen"
  # s.authors            = { "caowen" => "1149863953@qq.com" }
  # s.social_media_url   = "http://twitter.com/caowen"
  ...
  s.exclude_files = "lib/ISRDataHelper"
